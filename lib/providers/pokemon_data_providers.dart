...
final favouritePokemonProvider = StateNotifierProvider<FavouritePokemonsProvider, List<String>>((ref) {
...
class FavouritePokemonsProvider extends StateNotifier<List<String>> {
  ...
  Future<void> _setup() async {
    List<String>? result = await _databaseService.getList(FAVOURITE_POKEMON_LIST_KEY, state);
    state = result ?? [];
  }
